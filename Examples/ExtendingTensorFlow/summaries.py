...
- Activation: Histogram of operation output values.(Requires to add each
...
- Weight Decay: Decay of trainable variables with regulizer. (Requires
...
with tf.Graph().as_default():
    ...
    def dnn(x):
        with tf.name_scope('Layer1'):
            ...
            # Add weigths regulizer (Regul. summary automatically added)
        ...
        with tf.name_scope('Layer2'):
            ...
            # Add this 'tanh' op to activations collection or monitoring
            tf.add_to_collection(tf.GraphKeys.ACTIVATIONS, x)
            # Add weights regulizer (Regul. summary automatically added)
    ...
    #
    # Here, we generate a dummy variable given by the sum over current
