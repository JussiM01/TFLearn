...
# load a model
model.load("model.tf1")

# Or Load a model from auto-generated checkpoint
# >> model.load("model.tf1.ckpt-500")
...
# It is also possible to retrive a layer weights through its attributes 'W'
# and 'b' (if available).
# Get variable's value, using model 'get_weights' mehtod:
